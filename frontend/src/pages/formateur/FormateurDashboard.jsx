...
function FormateurDashboard() {
    ...
    const filterCourses = () => {
      ...
      const filtered = coursesToFilter.filter((course) => {
        ...
        const matchesSearch = (
          ...
          (course.createdBy && (
            course.createdBy.prenom.toLowerCase().includes(searchLower) ||
  ...
  const fetchCourses = async () => {
    try {
      ...
      const allCoursesData = allRes.data.data || allRes.data || [];
      const myCoursesData = myRes.data.data || myRes.data || [];
    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <button
            className={`sidebar-link ${showMessages ? 'active' : ''}`}
